...
cloudformation="file://${scriptDir//////}//cloudformation//lambdaEc2Snapshots.json"

# For each region configured
for region in $regions; do
  echo
  echo Deploying application in region $region
  echo
  ...
  echo "Cloudformation Stack now fully created in region $region"
